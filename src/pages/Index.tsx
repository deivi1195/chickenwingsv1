...
export default function Index() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      {/* Hero Section */}
      <section className="relative bg-cover bg-center h-[500px]" style={{ backgroundImage: "url('/assets/foods/hero-bg.jpg')" }}>
        <div className="absolute inset-0 bg-black opacity-40"></div>
        <div className="container mx-auto px-4 h-full flex items-center relative z-10">
          <div className="max-w-xl text-white">
            <span className="bg-red-600 text-white text-sm font-semibold px-3 py-1 rounded-full uppercase mb-4 inline-block">
              Free Delivery
            </span>
            ...
            <p className="text-lg mb-8 text-gray-200">
              Order your favorite meals online and we'll deliver them straight to your door in minutes.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We offer the best food delivery experience with premium quality products and services
            </p>
          </div>
